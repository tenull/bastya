...
<div className="mainabout-container mt-3 container">
            <div className="main-about d-flex flex-wrap">
               <img className="img-fluid col-lg-2" style={{ maxWidth: '200px' }} src="../kep2.jpg" alt="" />
               <p className="col-lg-10"> A település neve a méretére utal. A XIII. század közepén a szabolcsi várispánság birtoka, de a tatárjáráskor elpusztul. Az 1332. évi pápai tizedjegyzékben mint templomos hely szerepel, erről azonban nem történik említés. 1459-ben Egyházasnagyfalu néven említik. 1556-ban mintegy 350 lakosa lehetett.
                  ...
                  Az újkori egyház megalakulásának dátuma 1670, de még több, mint 100 évig semmit nem tudunk az egyház történetéről. Az 1779. évi visitatio szerint a faluban templom nincs, csak egy ima- és iskolaterem sárból és vesszőből, valmint harangláb. <br /></p>
            </div>
            <div className="middle-about d-flex flex-wrap">
               <p className="col-lg-10">
                  ...
                  Orgonáját Demény Imre építette 1938-ban három változattal. <br /></p>
               <img className="img-fluid col-lg-2" style={{ maxWidth: '200px' }} src="../kep2.jpg" alt="" />
            </div>
