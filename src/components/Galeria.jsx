  ...
  return (
    <div className="galeriatop">
      <div
        ...
        style={{
          backgroundImage: 'url(../virag2.jpg)',
          width: '100%',
          height: '300px',
      ...
      >
        <Container>
          <div className="d-flex justify-content-center">
            <h1 className="display-4 pt-5  textshadow text-white " style={{}}>
              Galéria
            </h1>
          </div>
        </Container>
      ...
      <div className="galeria-main">
        ...
        <div className="galeria-content">
          <Container
            className="rounded  mt-2 pt-2 pb-3 text-center"
            style={{ backgroundColor: '' }}
          >
            <div className="container mainpage-header mt-5">
              <p
                className="display-5  foglal m-0 text-center "
                style={{ color: '' }}
              >
                Programok
              </p>
            ...
            <Container className="d-flex justify-content-center flex-wrap">
              {imageData.map((item) => (
                <div
                  className="col-lg-4 mt-3 d-flex flex-column align-items-center "
                  key={item.title}
                >
          ...
          <div className="fogl-bottom" style={{ backgroundColor: '#EEEEEE' }}>
            <Container
              className="rounded  mt-5 pt-3  pb-5 text-center"
              style={{ backgroundColor: '' }}
            >
              <div className="container mainpage-header mt-5">
                <p
          ...
          >
            <Modal.Header closeButton>
              <Modal.Title className="d-flex justify-content-center ps-5">
                {actualData.title}
              </Modal.Title>
            </Modal.Header>
