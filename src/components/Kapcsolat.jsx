...
import { Email, HdrAuto, Mail } from "@mui/icons-material";
...
const Kapcsolat = () => {
  ...
  const isValid = () => {
    ...
    const handeSubmit = async (e) => {
        ...
        try {
            const res = await axios.post('http://api.emailjs.com/api/v1.0/email/send', data);
        ...
        <div className="kapcs-container">
            ...
            <div className="container kapcs-main p-5 mt-5">
                ...
                <div className="kapcs-header-bottom">
                    ...
                    <p className="fs-6 mb-1"> <Phone></Phone> +36 30 162 8381</p>
                    <p className="fs-6"><Mail></Mail>  bastyaidosotthon@gmail.com</p>
