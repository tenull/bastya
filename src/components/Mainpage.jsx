...
const Mainpage = () => {
  ...
  return (
    <div className="mainpage">
      ...
      <Swiper navigation={true} modules={[Navigation, Autoplay]} autoplay={{
        ...
        <SwiperSlide className='img-fluid' style={{ backgroundImage: 'url(../városnap.jpg)', height: '650px', backgroundSize: '100%', backgroundPosition: 'center' }}>
          <Container>
            <div className='swiper-container'>
              <Container>
                <p className='textshadow2 display-4'>Városnap 2023</p>
              </Container>
            </div>
          </Container>
        </SwiperSlide>
        ...
        {foglalkozasData.map((data, index) => (
          <div key={index} className="mainpage-container">
            <div className="card1 d-flex">
              <Card sx={{ Width: 300, maxWidth: 300, height: 500, backgroundColor: '#4A3429' }}>
                <CardActionArea>
                  <CardMedia
                    component="img"
                    height="400"
      ...
      <div className='mt-5 pb-5 mainpage-contentmain'>
